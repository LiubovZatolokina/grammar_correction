...
config_t5 = T5Config.from_json_file('t5_grammar_model/config.json')
t5_model = T5ForConditionalGeneration.from_pretrained('t5_grammar_model/pytorch_model.bin', config=config_t5)
